    ...
    <section id="caso" className="py-24 relative overflow-hidden">
      ...
      <div className="container relative z-10">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-12">
          {metrics.map((m, i) => (
            <motion.div
              ...
              className="group flex flex-col items-center text-center p-6 rounded-xl border border-border bg-card/50 backdrop-blur-sm hover:border-secondary/30 hover:shadow-[0_0_30px_hsl(155,60%,50%,0.08)] transition-all duration-300"
            >
        ...
        <motion.div
          ...
          viewport={{ once: true, margin: "-50px" }}
          transition={{ duration: 0.6 }}
          className="max-w-2xl mx-auto rounded-xl border border-border bg-card/50 backdrop-blur-sm p-8 relative hover:border-primary/20 hover:shadow-[0_0_40px_hsl(200,80%,55%,0.06)] transition-all duration-300"
        >
